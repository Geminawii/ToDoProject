...
const Slideshow = ({ images, interval = 8000 }) => {
  ...
  >
     <img
        ...
        alt={`Slide ${index + 1}`}
        className={`h-[60vh] w-auto object-cover rounded-lg shadow-xl transform transition-all duration-1000 ${
    ...
    <div className="flex gap-2 mt-2" role="tablist" aria-label="Slide indicators">
      {images.map((_, i) => (
        <button
          key={i}
